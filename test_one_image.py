...
def img_test(pretrained_model, img_path='/home/lpf/PycharmProjects/Dense-Scale-Network-for-Crowd-Counting-master/IMG_10.jpg'):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', default='/home/lpf/PycharmProjects/Dense-Scale-Network-for-Crowd-Counting-master/models/shanghai_model.pth',metavar='model path', type=str)
    parser.add_argument('--test_img_path', default='/home/lpf/PycharmProjects/Dense-Scale-Network-for-Crowd-Counting-master/IMG_10.jpg', metavar='test image path', type=str)
